...
from .evaluators import Evaluator, LangSmithEvaluator, OpenAIEvaluator, GeminiEvaluator, SimpleEvaluator
    ...
    match args.evaluator.lower():
        ...
        case "gemini":
            return GeminiEvaluator(model_name=args.evaluator_model_name,
                                   ...
                                   true_answer=args.needle)
        case "simple":
            return SimpleEvaluator(question_asked=args.retrieval_question,
                                   true_answer=args.needle)
        case "langsmith":
